...
const WhyUsCard = ({ icon, title }) => {
  return (
    <div className="text-center p-8 space-y-4 text-black bg-slate-100 hover:bg-secondary hover:text-white transition duration-200 ease-in-out rounded-md cursor-pointer">
      {icon}
